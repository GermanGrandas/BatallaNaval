...
(define (dibujo2 x)
  (if (<= x 500)
  (begin
    ((draw-rectangle ven2) (make-posn x 50) 50 50 "black")
    ((draw-rectangle ven2) (make-posn x 100) 50 50 "black")
    ((draw-rectangle ven2) (make-posn x 150) 50 50 "black")
    ((draw-rectangle ven2) (make-posn x 200) 50 50 "black")
    ((draw-rectangle ven2) (make-posn x 250) 50 50 "black")
    ((draw-rectangle ven2) (make-posn x 300) 50 50 "black")
    ((draw-rectangle ven2) (make-posn x 350) 50 50 "black")
    ((draw-rectangle ven2) (make-posn x 400) 50 50 "black")
    ((draw-rectangle ven2) (make-posn x 450) 50 50 "black")
    ((draw-rectangle ven2) (make-posn x 500) 50 50 "black")
...
(define (puntaje)
  (begin
    ...
    ((draw-string ven) (make-posn 640 150) (number->string (vector-ref vec 1)))
    )
  )
...
(define (jarvis x)
  (if (= (vector-ref vecb1 x) 1)
      (begin
        ((draw-solid-ellipse ven) (make-posn (+ 60(* 50(quotient x 10 ))) (+ 60(* 50 (remainder x 10)))) 15 15 "red")
        (- (vector-ref vec 1) 10)
      ...
      (if (= (vector-ref vecb1 x) 2)
          (jarvis (random 100))
          (begin
            ((draw-solid-ellipse ven) (make-posn (+ 60(* 50(quotient x 10 ))) (+ 60(* 50 (remainder x 10)))) 15 15 "white")
            (vector-set! vecb1  x 2)
            (converclick (get-mouse-click ven2) 0)
            )
          )
...
(define (estupidohumano y)
  (if (= 1 (vector-ref vecb2 y))
      (begin
        ((draw-solid-ellipse ven2)(make-posn (+ 60(* 50(quotient y 10 ))) (+ 60(* 50 (remainder y 10))) ) 15 15 "red")
        (+ (vector-ref vec 1) 20)
      ...
      (if (= (vector-ref vecb2 y) 2)
          (converclick (get-mouse-click ven2) 0)
          (begin
            ((draw-solid-ellipse ven2) (make-posn (+ 60(* 50(quotient y 10 ))) (+ 60(* 50 (remainder y 10))) ) 15 15 "white")
            (vector-set! vecb2 y 2)
            (centro 0)
            )
          )
...
(define (perdio)
  (begin
    ...
    (draw-solid-string (make-posn 140 140) (number->string (vector-ref vec 1)))
    (sleep 5)
    (stop)
    (exit)
    )
...
(define (gano)
  (begin
    (stop)
    (start 300 300)
    (draw-solid-string (make-posn 0 60) "                           Ganaste ") 
    (draw-solid-string (make-posn 0 100) "                     tu puntaje fue de:")
    (draw-solid-string (make-posn 140 140) (number->string (vector-ref vec 1)))
    (sleep 5)
    (stop)
